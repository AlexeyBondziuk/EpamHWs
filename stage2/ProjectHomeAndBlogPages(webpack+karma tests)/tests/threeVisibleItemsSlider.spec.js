import ThreeVisibleItemsSlider from '../src/js/sliders/ThreeVisibleItemsSlider.js';

describe("ThreeVisibleItemsSlider.js", function () {
    ...
    beforeEach(() => {
        ...
        slider = new ThreeVisibleItemsSlider(wrapper, sliderItems, prev, next, slides, slideSize)

...
import {createSearchSelectedPosts, deepClone, getItemFromMovieCollection, inputForAuthor} from './searchByInput.js';
    ...
    if (checkLocalStorage()) {
        ...
        if (jsonTitleItem) {
            ...
            requestMovieById(objItem.id)
                ...
                console.log(newMainDataForPost)
...
function getBackdropImage(mainDataForPost, numberOfFilm) {
    ...
    const defaultBackdropUrl = './img/no-image-icon-hi.png'
...
const popUpMessageData = new PopUpMessageData('info', 'Subscribe to this blog and get new updates first',
    1, 'light', false);

$('document').showPopup(popUpMessageData)
